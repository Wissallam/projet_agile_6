    ...
    <div class="modal-dialog" style="background-color:darkslateblue;color:darkslateblue;" >
      <div  class="modal-content" style="border-radius:60px;">
        ...
        <div class="loginform">
          ...
          <form method="POST" action="{{route('users.storee')}}" >
            @csrf
            <div class="mb-3">
        ...
        @endif
            ...
            <div class="modal-header" >
              ...
              <a style="position : absolute ; left:30px;border-radius:12px;" class="btn btn-secondary" type="button" href="{{ route('resolveurs.index') }}">Retour</a>
            </div>
          </form>
        </div>
