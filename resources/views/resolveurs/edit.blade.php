      ...
      <h5 class="modal-title" style="margin-left:130px; " >Modifications des Informations </h5>
       ...
       <?php
        ...
        ?>  
                ...
                <form method="POST" action="{{route('resolveurs.update',['resolveur'=>$resolveur->id])}}" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="mb-3">
                  ...
                  @endif
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control"style="border-radius:20px;" id="name" name="name" value="{{old('name',$resolveur->name)}}" type="text" aria-describedby="emailHelp">
                        @if ($errors->has('name'))
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control" style="border-radius:20px;" id="email" name="email" value="{{old('email',$resolveur->email)}}" type="text" aria-describedby="emailHelp">
                        @if ($errors->has('email'))
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control"style="border-radius:20px;" id="specialite" name="specialite" value="{{old('specialite',$resolveur->specialite)}}" type="integer" aria-describedby="emailHelp">
                    ...
                    @endif
                      ...
                      <div class="mb-3">
                        ...
                        <input class="form-control"style="border-radius:20px;" id="phone" name="phone" value="{{old('phone',$resolveur->phone)}}" type="integer" aria-describedby="emailHelp">
                  ...
                  @endif
                    ...
                    <div class="modal-footer">
                      ...
                      <a style="position : absolute ; left:30px;" class="btn btn-secondary"  type="button" href="{{ route('resolveurs.index') }}">Retour</a>
                    </div>
                  </form>
                  </div>
