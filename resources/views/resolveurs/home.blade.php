      ...
      <header class="header z-index-50">
        <nav class="navbar py-3 px-0 shadow-sm text-white position-relative">
          ...
          <div class="search-box shadow-sm">
            ...
            @if (Route::is('ticketchefs.index'))
            <form action="{{route('ticketchefs.search')}}">
              <input class="for-control shadow-0"  type="text" name="q"  placeholder="Qu'est ce que vous chercher...">
             
            </form>
  
            @else
            @if (Route::is('ticks.index'))
            <form action="{{route('ticks.search')}}">
              <input class="for-control shadow-0"  type="text" name="q"  placeholder="Qu'est ce que vous chercher...">
             
            </form>
            @else
            @if (Route::is('adferms.index'))
            <form action="{{route('adferms.search')}}">
              <input class="for-control shadow-0"  type="text" name="q"  placeholder="Qu'est ce que vous chercher...">
             
            </form>
            @else
            @if (Route::is('resfes.index'))
            <form action="{{route('resfes.search')}}">
              <input class="for-control shadow-0"  type="text" name="q"  placeholder="Qu'est ce que vous chercher...">
   ...
   ?>
      <div class="page-content d-flex align-items-stretch"> 
        ...
        <nav class="side-navbar z-index-40">
          <!-- Sidebar Header-->
          <div class="sidebar-header d-flex align-items-center py-4 px-3"><img class="avatar shadow-0 img-fluid rounded-circle" src="{{ asset('./uploads/' .$resolveur->image)}}"
            " alt="...">
            <div class="ms-3 title">
              <h5>{{$resolveur->name}}</h5>
              <p class="text-sm text-gray-500 fw-light mb-0 lh-1">Résolveur </p>
            </div>
          </div>
          ...
          <ul class="list-unstyled py-4">
            ...
            @if(Route::is('home'))
                <li class="sidebar-item active"><a class="sidebar-link" href="{{ route('profile') }}"> 
                ...
                <li class="sidebar-item active"><a class="sidebar-link" href="{{ route('profile') }}"> 
                  <svg class="svg-icon svg-icon-sm svg-icon-heavy me-xl-2">
                    ...
                    <li class="sidebar-item "><a class="sidebar-link" href="{{ route('resolveurs.profile') }}"> 
                      <svg class="svg-icon svg-icon-sm svg-icon-heavy me-xl-2">
                        <use xlink:href="#quality-1"> </use>
                      </svg>Profile </a></li>
                <li class="sidebar-item active "><a class="sidebar-link" href="#exampledropdownDropdown" data-bs-toggle="collapse"> 
                  ...
                  <ul class="collapse list-unstyled " id="exampledropdownDropdown">
                    ...
                    @if (Route::is('tickets.create')) 
                    <li class="sidebar-item"><a class="sidebar-link" href="{{ route('ticketchefs.index') }}">Tickets à Analyser</a></li> 
                    @else 
                    <li class="sidebar-item"><a class="sidebar-link" href="{{ route('ticketchefs.index') }}">Tickets à Analyser</a></li> 
                    @endif  
                    <li class="sidebar-item"><a class="sidebar-link" href="{{ route('ticks.index') }}">Tickets à résoudre</a></li>
                    <li class="sidebar-item  "><a class="sidebar-link" href="#example" data-bs-toggle="collapse"> 
                      </svg>Tickets fermés </a>
                      <ul class="collapse list-unstyled " id="example">
                    <li class="sidebar-item"><a class="sidebar-link" href="{{ route('resfes.index') }}">comme résolveur</a></li> 
                    <li class="sidebar-item"><a class="sidebar-link" href="{{ route('adferms.index') }}">admin de projet</a></li> 
                      </ul></li>
                  </ul></li>
                  
                  @else
                  @if (Route::is('resolveurs.profile')) 
                  <li class="sidebar-item active "><a class="sidebar-link" href="{{ route('resolveurs.profile') }}"> 
                    <svg class="svg-icon svg-icon-sm svg-icon-heavy me-xl-2">
                      <use xlink:href="#quality-1"> </use>
                    </svg>Profile </a></li>
            ...
            <li class="sidebar-item active "><a class="sidebar-link" href="#exampledropdownDropdown" data-bs-toggle="collapse"> 
              ...
              <ul class="collapse list-unstyled " id="exampledropdownDropdown">
                ...
                <li class="sidebar-item active"><a class="sidebar-link" href="{{ route('ticketchefs.index') }}">Tickets à Analyser</a></li> 
              ...
              <ul class="collapse list-unstyled " id="example">
                ...
                <li class="sidebar-item"><a class="sidebar-link" href="{{ route('adferms.index') }}">admin de projet</a></li> 
                 ...
                 @else
                 @if (Route::is('ticketchefs.search')) 
                 <li class="sidebar-item  "><a class="sidebar-link" href="{{ route('resolveurs.profile') }}"> 
                  <svg class="svg-icon svg-icon-sm svg-icon-heavy me-xl-2">
                    <use xlink:href="#quality-1"> </use>
                  </svg>Profile </a></li>
             ...
             <li class="sidebar-item active "><a class="sidebar-link" href="#exampledropdownDropdown" data-bs-toggle="collapse"> 
              ...
              <ul class="collapse list-unstyled " id="example">
                ...
                <li class="sidebar-item"><a class="sidebar-link" href="{{ route('adferms.index') }}">admin de projet</a></li> 
                 ...
                 @else
                 @if (Route::is('tickets_resolveurs.create')) 
                 <li class="sidebar-item  "><a class="sidebar-link" href="{{ route('resolveurs.profile') }}"> 
                  <svg class="svg-icon svg-icon-sm svg-icon-heavy me-xl-2">
                    <use xlink:href="#quality-1"> </use>
                  </svg>Profile </a></li>
           ...
           <li class="sidebar-item active "><a class="sidebar-link" href="#exampledropdownDropdown" data-bs-toggle="collapse"> 
            <svg class="svg-icon svg-icon-sm svg-icon-heavy me-xl-2">
             ...
             <ul class="collapse list-unstyled " id="exampledropdownDropdown">
               ...
               <li class="sidebar-item active"><a class="sidebar-link" href="{{ route('ticks.index') }}">Tickets à résoudre</a></li>
               <li class="sidebar-item  "><a class="sidebar-link" href="#example" data-bs-toggle="collapse"> 
         ...
         <li class="sidebar-item active "><a class="sidebar-link" href="#exampledropdownDropdown" data-bs-toggle="collapse"> 
          <svg class="svg-icon svg-icon-sm svg-icon-heavy me-xl-2">
           ...
           <ul class="collapse list-unstyled " id="exampledropdownDropdown">
             ...
             <li class="sidebar-item "><a class="sidebar-link" href="{{ route('ticks.index') }}">Tickets à résoudre</a></li>
             <li class="sidebar-item active  "><a class="sidebar-link" href="#example" data-bs-toggle="collapse"> 
                    
              <use xlink:href="#real-estate-1"> </use>
            Tickets fermés </a>
          <ul class="collapse list-unstyled " id="example">
            <li class="sidebar-item active"><a class="sidebar-link" href="{{ route('resfes.index') }}">comme résolveur</a></li> 
            <li class="sidebar-item"><a class="sidebar-link" href="{{ route('adferms.index') }}">admin de projet</a></li> 
...
@else
  ...
  <li class="sidebar-item active "><a class="sidebar-link" href="#exampledropdownDropdown" data-bs-toggle="collapse"> 
   ...
   <ul class="collapse list-unstyled " id="example">
    <li class="sidebar-item"><a class="sidebar-link" href="{{ route('resfes.index') }}">comme résolveur</a></li> 
    <li class="sidebar-item active"><a class="sidebar-link" href="{{ route('adferms.index') }}">admin de projet</a></li> 

   </ul></li>
</ul></li>
                 @else
                 @if (Route::is('adferms.search')) 
                 <li class="sidebar-item  "><a class="sidebar-link" href="{{ route('resolveurs.profile') }}"> 
                  <svg class="svg-icon svg-icon-sm svg-icon-heavy me-xl-2">
                    <use xlink:href="#quality-1"> </use>
                  </svg>Profile </a></li>
