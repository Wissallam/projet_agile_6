...
<html>
	<head>
		...
		<link
			rel="stylesheet"
			type="text/css"
			href="{{url('css/cssdc/dataTables.bootstrap4.min.css')}}"
		/>
		<link
			rel="stylesheet"
			type="text/css"
			href="{{url('css/cssdc/responsive.bootstrap4.min.css')}}"
		/>
	...
	<body>
		<div class="pre-loader">
			<div class="pre-loader-box">
				<div class="loader-logo">
					<img src="{{url('image/deskapp-logo.svg')}}" />
				</div>
			...
			<div class="header-right">
						...
						<div class="dropdown-menu dropdown-menu-right">
							<div class="notification-list mx-h-350 customscroll">
								<ul>
									...
									<li>
										<a href="#">
											<img src="{{url('image/photo1.jpg')}}" alt="" />
											<h3>Lea R. Frith</h3>
											<p>
												Lorem ipsum dolor sit amet, consectetur adipisicing
												elit, sed...
									...
									<li>
										<a href="#">
											<img src="{{url('image/photo2.jpg')}}" alt="" />
									...
									<li>
										<a href="#">
											<img src=="{{url('image/photo3.jpg')}}" alt="" />
											<h3>John Doe</h3>
											<p>
												Lorem ipsum dolor sit amet, consectetur adipisicing
												elit, sed...
									...
									<li>
										<a href="#">
											<img src="{{url('image/photo4.jpg')}}" alt="" />
				...
				<div class="github-link">
					<a href="https://github.com/dropways/deskapp" target="_blank"
						><img src=="{{url('image/github.svg')}}" alt=""
					/></a>
				</div>
			</div>
		</div>
			...
			<div class="pd-ltr-20">
				<div class="card-box pd-20 height-100-p mb-30">
					<div class="row align-items-center">
						<div class="col-md-4">
							<img src="{{url('image/banner-img.png')}}" alt="" />
						</div>
						<div class="col-md-8">
		...
		<script src="{{url('js/process.js')}}"></script>
		<script src="{{url('js/process.js')}}"></script>
		<script src="{{url('js/layout-settings.js')}}"></script>
		<script src="{{url('js/jquery.dataTables.min.js')}}"></script>
		<script src="{{url('js/dataTables.bootstrap4.min.js')}}"></script>
		<script src="{{url('js/dataTables.responsive.min.j')}}"></script>s
