...
<div class="content-inner w-100">
    ...
    <!-- Forms Section-->
        ...
        @foreach($resol as $reso)
        
            @if(($reso==$resolveurss->id) &&  (!($ticket->statut=="Résolu")&&!($ticket->situation=="Refusé")))
...
<?php
    ...
    <div class="table-responsive" >
      ...
      <a  class="btn btn-primary" style="border-radius:10px; background-color:darkgreen;" class="btn btn-secondary" type="button" href="{{route('ticks.edit',[$ticket->id])}}" >Marquer la résolution</a>
      @endif
      <h6 style="text-align:center;">Réclamation conserne la société:&nbsp;<span style="color:brown;">{{$client->name}}</span></h6>
