...
<div class="content-inner w-100">
    ...
    <div class="table-responsive" >
      @if(($reclameurs->is_chef_reclameur=="true") &&($ticket->situation=="Pas encore définie"))
      <a style=" border-radius:10px; background-color:darkorange;" class="btn btn-primary" type="button" href="{{route('tickets.edit',[$ticket->id])}}">Modifier</a>
      @endif
