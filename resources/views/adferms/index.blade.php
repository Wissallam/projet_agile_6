...
$resolveurss =Resolveur::where('user_id',$authentifier)->first();
?>



 @if($ticket->chef==$resolveurss->id )
...
?>
 ...
 <div class="table-responsive" >
  @if(($ticket->statut=="En attente")&&($ticket->situation=="Refusé"))
  <a  class="btn btn-primary" style="border-radius:10px; background-color:darkorange;" class="btn btn-secondary" type="button" href="{{route('ticketchefs.edit',[$ticket->id])}}" >Réagir</a>
  @endif
 <h6 style="text-align:center;">Responçable de la réclamation:&nbsp;<span style="color:brown;">{{$resolveurss->name}}</span></h6>
...
@endif 
     ...
     <?php $resol=explode(',',$ticket->resolveurs);?>
