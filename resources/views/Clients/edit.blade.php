    ...
    <div class="loginform">
                ...
                <form method="POST" action="{{route('clients.update',['client'=>$client->id])}}" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                      ...
                      <input class="form-control" style="border-radius:20px;"  id="name" name="name" value="{{old('name',$client->name)}}" type="text" aria-describedby="emailHelp" required>
                      @if ($errors->has('name'))
                  ...
                  @endif
                    ...
                    <div class="mb-3">
                      ...
                      <input class="form-control"  style="border-radius:20px;"  id="email" name="email" value="{{old('name',$client->email)}}" type="email" required>
                      @if ($errors->has('email'))
                  ...
                  @endif
                    ...
                    <div class="mb-3">
                      ...
                      <input class="form-control" style="border-radius:20px;"  id="phone"  type="phone" name="phone" value="{{old('name',$client->phone)}}" required autocomplete="new-password">
                    </div>
                    <div class="row">
                        <label class="label-material" for="image">Logo</label>
                        <div class="col-sm-9">
                          <input class="form-control" style="  position:center-align;border-radius:20px;  width:420px;margin: auto;text-align:center;"  id="image" name="image" value="{{old('name',$client->image)}}" type="file">
                        </div>
                      </div>
                      <br>
